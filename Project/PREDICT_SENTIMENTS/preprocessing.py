...
contractions, insert space between words and punctuations, sentence tokenization, lowercasing,
remove stop words, and lemmatization.

Output file: prepared_amazon_mobile_datasets.csv
"""
...
filename ="PREDICT_SENTIMENTS/uploads/"+var
...
pd.DataFrame(review).to_csv('PREDICT_SENTIMENTS/results/prepared.csv', index=False, header=None)
sleep(0.5)
